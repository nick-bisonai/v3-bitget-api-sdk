...
func (p *SpotOrderClient) Init(opts ...common.ClientOption) *SpotOrderClient {
	p.BitgetRestClient = new(common.BitgetRestClient).Init(opts...)
	return p
}

// normal order
func (p *SpotOrderClient) PlaceOrder(params map[string]string) ([]byte, error) {
...
func (p *SpotOrderClient) BatchPlaceOrder(params map[string]string) ([]byte, error) {
	postBody, jsonErr := utils.ToJson(params)
	if jsonErr != nil {
		return nil, jsonErr
	}
...
func (p *SpotOrderClient) CancelOrder(params map[string]string) ([]byte, error) {
	postBody, jsonErr := utils.ToJson(params)
	if jsonErr != nil {
		return nil, jsonErr
	}
...
func (p *SpotOrderClient) BatchCancelOrders(params map[string]string) ([]byte, error) {
	postBody, jsonErr := utils.ToJson(params)
	if jsonErr != nil {
		return nil, jsonErr
	}
...
func (p *SpotOrderClient) OrdersHistory(params map[string]string) ([]byte, error) {
	resp, err := p.BitgetRestClient.DoGet("/api/v2/spot/trade/history-orders", params)
	return resp, err
}

func (p *SpotOrderClient) OrdersPending(params map[string]string) ([]byte, error) {
	resp, err := p.BitgetRestClient.DoGet("/api/v2/spot/trade/unfilled-orders", params)
	return resp, err
}

func (p *SpotOrderClient) Fills(params map[string]string) ([]byte, error) {
	resp, err := p.BitgetRestClient.DoGet("/api/v2/spot/trade/fills", params)
	return resp, err
}

// plan
func (p *SpotOrderClient) PlacePlanOrder(params map[string]string) ([]byte, error) {
	postBody, jsonErr := utils.ToJson(params)
	if jsonErr != nil {
		return nil, jsonErr
	}
...
func (p *SpotOrderClient) CancelPlanOrder(params map[string]string) ([]byte, error) {
	postBody, jsonErr := utils.ToJson(params)
	if jsonErr != nil {
		return nil, jsonErr
	}
...
func (p *SpotOrderClient) OrdersPlanPending(params map[string]string) ([]byte, error) {
	resp, err := p.BitgetRestClient.DoGet("/api/v2/spot/trade/current-plan-order", params)
	return resp, err
}

func (p *SpotOrderClient) OrdersPlanHistory(params map[string]string) ([]byte, error) {
	resp, err := p.BitgetRestClient.DoGet("/api/v2/spot/trade/history-plan-order", params)
	return resp, err
}

// trader
func (p *SpotOrderClient) TraderOrderCloseTracking(params map[string]string) ([]byte, error) {
	postBody, jsonErr := utils.ToJson(params)
	if jsonErr != nil {
		return nil, jsonErr
	}
...
func (p *SpotOrderClient) TraderOrderCurrentTrack(params map[string]string) ([]byte, error) {
	resp, err := p.BitgetRestClient.DoGet("/api/v2/copy/spot-trader/order-current-track", params)
	return resp, err
}

func (p *SpotOrderClient) TraderOrderHistoryTrack(params map[string]string) ([]byte, error) {
