...
func (p *SpotMarketClient) Products(params map[string]string) ([]byte, error) {
	resp, err := p.BitgetRestClient.DoGet("/api/spot/v1/public/products", params)
	return resp, err
}

func (p *SpotMarketClient) Product(params map[string]string) ([]byte, error) {
...
func (p *SpotMarketClient) Depth(params map[string]string) ([]byte, error) {
...
func (p *SpotMarketClient) Ticker(params map[string]string) ([]byte, error) {
